<x-guest-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Anakart ve mikro lehim') }}</h2>
    </x-slot>
    ...
    <main class="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        <article class="rounded-[2rem] border border-gray-200 bg-white p-8 shadow-xl dark:border-gray-700 dark:bg-gray-800">
            ...
            <h1 class="mt-3 text-4xl font-black text-gray-950 dark:text-white">Anakart ve mikro lehim</h1>
            <p class="mt-5 text-lg leading-8 text-gray-600 dark:text-gray-300">Sıvı teması, kısa devre, kopuk hat, entegre ve komponent düzeyi arızalar teknik ekipmanla analiz edilir.</p>
            <ul class="mt-8 grid gap-3 sm:grid-cols-3">
                    <li class="rounded-2xl bg-sky-50 px-4 py-3 text-sm font-semibold text-sky-800 dark:bg-sky-500/10 dark:text-sky-100">Mikroskop altında kontrol</li>
                    <li class="rounded-2xl bg-sky-50 px-4 py-3 text-sm font-semibold text-sky-800 dark:bg-sky-500/10 dark:text-sky-100">Kısa devre ve hat ölçümü</li>
                    <li class="rounded-2xl bg-sky-50 px-4 py-3 text-sm font-semibold text-sky-800 dark:bg-sky-500/10 dark:text-sky-100">Komponent/entegre müdahalesi</li>
            </ul>
